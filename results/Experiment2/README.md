...
Check how TTSR behaves on the inpainting task. Observe when overfitting happens that fast on higher resolution images (384x384). Try only reconstruction loss.
