...
class SearchTransferSoftAttn(nn.Module):
    def __init__(self):
        super(SearchTransferSoftAttn, self).__init__()
...
class SearchTransferTrainableWeights(nn.Module):
    def __init__(self):
        super(SearchTransferTrainableWeights, self).__init__()
...
class SearchTransferAllFeatures(nn.Module):
    def __init__(self):
        super(SearchTransferAllFeatures, self).__init__()
    ...
    def forward(self, lrsr_lv1, lrsr_lv2, lrsr_lv3, refsr_lv3, ref_lv1, ref_lv2, ref_lv3, return_attention):
        ...
        ref_lv3_unfold = self.w_vs(ref_lv3_unfold.transpose(1, 2)).transpose(1, 2)
